...
def upload_files(list_of_files, temp_zip_dir, upload_zip_file_name, container_name):
    zip_file_base_name = os.path.basename(upload_zip_file_name)
    start_time = datetime.datetime.now()
    print('Uploading {} file(s) to cloud. Starting at {}'.format(len(list_of_files), start_time))
